...
import (
	...
	"github.com/lpoclin/5g-observer/api-server/internal/handlers"
	"github.com/lpoclin/5g-observer/api-server/internal/k8s"
	"github.com/lpoclin/5g-observer/api-server/internal/loki"
...
func main() {
	...
	metH     := handlers.NewMetricsHandler(promClient)
	...
	go func() {
		log.Info().Str("addr", addr).Msg("5g-observer api-server starting")
